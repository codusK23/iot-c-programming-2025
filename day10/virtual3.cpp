...
public:
	...
	~CTest() { std::cout << num << " CTest Destructor" << std::endl; }
...
private:
	int subN;
public:
	CTestSub(int an1, int an2) : CTest(an1), subN(an2) { std::cout << subN << " CTestSub Constructor" << std::endl; }
	~CTestSub() { std::cout << subN << " CTest Destructor" << std::endl; }
